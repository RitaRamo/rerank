...
from toolkit.utils import rm_caption_special_tokens, MODEL_BOTTOM_UP_TOP_DOWN_CONTEXT_LSTM, get_log_file_path, decode_caption
...
def evaluate(image_features_fn, dataset_splits_dir, split, checkpoint_path, output_path,
    ...
    if model_name == MODEL_BOTTOM_UP_TOP_DOWN_CONTEXT_LSTM:
        ...
        raise Exception("Only bottom up top down context lstm model allowed")
        target_lookup=None
