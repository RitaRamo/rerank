...
MODEL_BOTTOM_UP_TOP_DOWN_RETRIEVAL = "BOTTOM_UP_TOP_DOWN_RETRIEVAL"
MODEL_BOTTOM_UP_TOP_DOWN_CONTEXT = "BOTTOM_UP_TOP_DOWN_CONTEXT"
MODEL_BOTTOM_UP_TOP_DOWN_CONTEXT_LSTM = "BOTTOM_UP_TOP_DOWN_CONTEXT_LSTM"
